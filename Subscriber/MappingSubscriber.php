...
//        protected $content;
        if (!$metadata->hasAssociation('content')) {
            $builder = new ClassMetadataBuilder($metadata);
            $builder->createField('content', 'text')->length(65535)->nullable(false)->build();
        }
...
//        protected $message;
        ...
        if (!$metadata->hasAssociation('message')) {
            $builder = new ClassMetadataBuilder($metadata);
            $builder->createField('message', 'string')->nullable(true)->build();
        }
...
//        protected $file;
        if (!$metadata->hasAssociation('file')) {
            $builder = new ClassMetadataBuilder($metadata);
            $builder->createField('file', 'string')->nullable(false)->build();
        }
...
//        /**
//         * @ORM\Column(name="stack_trace_string", type="text", length=65535, nullable=false)
//         */
//        protected $stackTraceString;
        if (!$metadata->hasAssociation('stackTraceString')) {
            $builder = new ClassMetadataBuilder($metadata);
            $builder->createField('stackTraceString', 'text')->length(65535)->nullable(false)->build();
        }
...
//        protected $json;
        if (!$metadata->hasAssociation('json')) {
            $builder = new ClassMetadataBuilder($metadata);
            $builder->createField('json', 'text')->length(65535)->nullable(false)->build();
        }
...
//        protected $extraData;
        if (!$metadata->hasAssociation('extraData')) {
            $builder = new ClassMetadataBuilder($metadata);
            $builder->createField('extraData', 'text')->length(65535)->nullable(true)->build();
        }
